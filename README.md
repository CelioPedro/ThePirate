...
![The Pirate Max responsive web preview](docs/assets/preview-web-rounded.webp)
...
<p>
  ...
  <img alt="Infra" src="https://img.shields.io/badge/Infra-Docker%20%2B%20Nginx-0284c7?style=flat&logo=docker&logoColor=white">
</p>
...
![The Pirate Max login preview](docs/assets/preview-login-rounded.webp)
...
<div align="center">
  ...
  <img alt="Vite" width="42" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vitejs/vitejs-original.svg">
  <img alt="Java" width="42" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg">
  <img alt="Spring" width="42" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/spring/spring-original.svg">
  ...
  <img alt="Nginx" width="42" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nginx/nginx-original.svg">
...
| Experiencia do cliente | Operacao administrativa | Plataforma |
| --- | --- | --- |
| Catalogo por categoria | Gestao de produtos | API Spring Boot |
| Cadastro e login | Pedidos em validacao | PostgreSQL com Flyway |
| Carrinho e pedidos | Estoque de credenciais | Docker na Oracle Cloud |
| Consulta de compras | Entrega protegida | Vercel + Nginx + HTTPS |
